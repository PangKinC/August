...
public class Processor {
    ...
    static void editContact(int index, List<String> data) {
        ...
        contacts.get(index).getAddress().setLineOne(data.get(5));
        contacts.get(index).getAddress().setLineTwo(data.get(6));
        contacts.get(index).getAddress().setTown(data.get(7));
        contacts.get(index).getAddress().setCounty(data.get(8));
        contacts.get(index).getAddress().setPostcode(data.get(9));
